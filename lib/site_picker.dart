...
class _SitePickerState extends State<SitePicker> {
  ...
  Widget build(BuildContext context) =>
      Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        const AppText('Drag the map to place the pin at your work site.'),
            ...
            child: SizedBox(
                ...
                child: Stack(alignment: Alignment.center, children: [
                  FlutterMap(
                      ...
                      options: MapOptions(
                        initialCenter: chosen ?? const LatLng(20, 0),
                        initialZoom: chosen == null ? 2 : 16,
                        onPositionChanged: (camera, gesture) {
                          if (gesture) choose(camera.center);
                        },
                        onTap: (_, point) {
        ...
        OutlinedButton.icon(
            ...
            label: AppText(
                locating ? 'Finding your location…' : 'Use my exact location')),
        if (error != null)
